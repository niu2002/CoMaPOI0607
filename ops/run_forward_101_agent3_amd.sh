...
export AGENT2_API="${AGENT2_API:-$BASE_API_NAME}"
export AGENT3_API="${AGENT3_API:-agent3}"
export OP_STR="${OP_STR:-amd-forward-101-top10-agent3-fused}"
...
export CANDIDATE_FUSION_STRATEGY="${CANDIDATE_FUSION_STRATEGY:-rrf}"
